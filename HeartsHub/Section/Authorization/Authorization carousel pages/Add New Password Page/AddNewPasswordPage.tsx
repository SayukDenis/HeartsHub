...
import {
  ...
  hasUpperCase,
  hasWhitespace,
} from "../Add Password page/Functions";

class AddNewPasswordPage extends RegistrationPage {
  ...
  render() {
    ...
    return (
      <View style={{ width }}>
        <AuthorizationTitle
          text={
            secondPassword == "" ? "Введи пароль" : "  Введи поточний пароль"
          }
        />
        <AuthorizationInput
...
export default connect(mapStateToProps)(AddNewPasswordPage);
