...
interface ReverseCameraSVGProps{
    widthOfReverseCamera?:number;
}
const ReverseCameraSVG:React.FC<ReverseCameraSVGProps> = ({widthOfReverseCamera=width*0.3}) => {
  return (
    <Svg width={widthOfReverseCamera*0.25} height={widthOfReverseCamera*0.18} viewBox="0 0 25 18" fill="none">
      <Path
